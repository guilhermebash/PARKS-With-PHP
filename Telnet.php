	...
	*/
	function connect($server,$user,$pass) {
		...
		*/
		...
		/* DISCONECTAR CASO HAJA ALGUMA CONEXÃO JÁ ABERTA */
		
		$this->Disconnect();
		
		/* FORMATAR IP xxx.xxx.xxx.xx */
	...
	function ConnectError($num) {
		...
		//}
		if ($this->show_connect_error) switch ($num) {
		case 1: throw new Exception('<br />[PHP Telnet] <a href="http://www.geckotribe.com/php-telnet/errors/fsockopen.php">Connect failed: Unable to open network connection</a><br />'); break;
		case 2: throw new Exception('<br />[PHP Telnet] <a href="http://www.geckotribe.com/php-telnet/errors/unknown-host.php">Connect failed: Unknown host</a><br />'); break;
		case 3: throw new Exception('<br />[PHP Telnet] <a href="http://www.geckotribe.com/php-telnet/errors/login.php">Connect failed: Login failed</a><br />'); break;
		case 4: throw new Exception('<br />[PHP Telnet] <a href="http://www.geckotribe.com/php-telnet/errors/php-version.php">Connect failed: Your server\'s PHP version is too low for PHP Telnet</a><br />'); break;
		}		
	}
}
